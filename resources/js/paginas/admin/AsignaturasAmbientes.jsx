...
function AsignaturasAmbientes({ onNavigate }) {
    const [asignaturas, setAsignaturas] =
        React.useState(asignaturasIniciales);

    const [ambientes, setAmbientes] =
        React.useState(ambientesIniciales);

    /* =========================
       ESTADO ASIGNATURAS
    ========================== */

    const [mostrarFormularioAsignatura, setMostrarFormularioAsignatura] =
        React.useState(false);

    const [asignaturaEditando, setAsignaturaEditando] =
        React.useState(null);

    const [nuevaAsignatura, setNuevaAsignatura] =
        React.useState({
            materia: "",
            docente: "",
        });
    ...
    const [mostrarFormularioAmbiente, setMostrarFormularioAmbiente] =
        React.useState(false);

    const [ambienteEditando, setAmbienteEditando] =
        React.useState(null);

    const [nuevoAmbiente, setNuevoAmbiente] =
        React.useState({
            nombre: "",
            capacidad: "",
            estado: "Disponible",
    ...
    const guardarAmbiente = () => {
        if (
            nuevoAmbiente.nombre.trim() === "" ||
            nuevoAmbiente.capacidad.trim() === ""
        ) {
